                                                        ...
                                                        <div className="flex items-center justify-center min-h-full p-4 text-center">
                                                            <DialogPanel className="w-full max-w-md p-6 mx-auto bg-white rounded">
                                                                ...
                                                                <div className="mt-4 flex justify-between">
                                                                    <button onClick={handleCloseDialog} className="px-4 py-2 bg-gray-200 rounded">Cancel</button>
                                                                    <button onClick={() => handleDelete(expense.id)} className="px-4 py-2 bg-red-600 text-white rounded">
